...
export default function SubscribePageContent() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-12 md:py-20">
      <div className="space-y-4 text-center">
        ...
        <p className="mx-auto max-w-3xl text-base text-zinc-300 md:text-lg">
          Every subscription funds a charity you choose. Every score enters you
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <article className="rounded-3xl border border-zinc-800 bg-zinc-900/70 p-8 backdrop-blur">
          ...
          <p className="mt-3 text-4xl font-bold">₹949/month</p>
